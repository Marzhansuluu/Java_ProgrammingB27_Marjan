...
import day19_for_loops.palindrome;
...
public class LongestPalindrome {
	...
	Given a String array. Find the longest Palindrome String in your array.
        ...
        for(String each : words){
            ...
            if(each.equalsIgnoreCase(palindrome) && each.length() > palindrome.length());



        }
//        System.out.println("All the palindrome words: " + result.substring(0, result.lastIndexOf(" ")));
