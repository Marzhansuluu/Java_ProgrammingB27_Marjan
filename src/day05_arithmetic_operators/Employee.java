...
public class Employee {
    public static void main(String[] args) {
        ...
        String summary = "Employee Information for "+fullName + ". " + jobTitle + " for" + companyName + ", based in suite " + suite + fullName + " is full time: " + isFullTime + ". " + "Contact " + fullName + " at " + email +". " + "Current benefits include " + benefits;
