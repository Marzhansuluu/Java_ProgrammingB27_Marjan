...
public class StringEquals {
    public static void main(String[] args) {
        String s = "java";
        String s2 = "java";// both are in string pool, string literal
        ...
        System.out.println("s.equals(s3) " + s.equals(s3)); // checks if the value (character) of the String are the same
