...
public class EasyData {
    ...
    public static ArrayList<Integer> getRandomNumbers(int limit){
        Random random = new Random(); //Research about this class, look at this documentation
        ArrayList<Integer> list = new ArrayList<>();
        for(int i = 0; i < limit; i++){
            list.add(random.nextInt(1000));// 0-1000 means. I will generate the random number between 0-1000.
        }
        return list;
    }
