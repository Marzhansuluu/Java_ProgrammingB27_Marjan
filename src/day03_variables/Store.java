...
public class Store {
    public static void main(String[] args) {
        ...
        numberOfItems=700; /*if we change the value into 700, from now on the numberOfItem will have a new value.*/
        ...
        double totalCost = 1000000.99; // 1,000,000.99 how we might want to write it, but commas are not valid java syntax , so we can use underscore in number, to improve readability 1_000_000
        ...
        long pop2= 1_000_000; //L is nor needed because 1 million is a valid number for int types, and that type can automatically
    }
}
