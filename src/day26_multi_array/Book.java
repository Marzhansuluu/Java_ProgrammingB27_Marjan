...
public class Book {
    public static void main(String[] args) {
        ...
        for(int i = 0; i < chapters; i++){
           ...
           book[i] = input.nextLine().trim().split(" ");// reading a String from the console then trimming the extra spaces in the beginning and end and finally splitting the array by the space, getting a String array with each word as a separate element. That String array is stored into the book 2D array.
